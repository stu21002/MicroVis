...
exports.FileInfoResponse = exports.FileInfoRequest = exports.protobufPackage = void 0;
/* eslint-disable */
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const defs_1 = require("./defs");
exports.protobufPackage = "proto";
function createBaseFileInfoRequest() {
    return { uuid: "", directory: "", file: "", hdu: "" };
}
exports.FileInfoRequest = {
    ...
    create(base) {
        return exports.FileInfoRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c, _d;
        const message = createBaseFileInfoRequest();
        message.uuid = (_a = object.uuid) !== null && _a !== void 0 ? _a : "";
        message.directory = (_b = object.directory) !== null && _b !== void 0 ? _b : "";
        message.file = (_c = object.file) !== null && _c !== void 0 ? _c : "";
        message.hdu = (_d = object.hdu) !== null && _d !== void 0 ? _d : "";
        return message;
    },
};
function createBaseFileInfoResponse() {
    return { success: false, message: "", fileInfo: undefined, fileInfoExtended: undefined };
}
exports.FileInfoResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    create(base) {
        return exports.FileInfoResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseFileInfoResponse();
