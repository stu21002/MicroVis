...
exports.H5ServicesClient = exports.H5ServicesService = exports.H5ReadersClient = exports.H5ReadersService = exports.SpatialProfileData = exports.SetHistogramReq = exports.SetSpatialReq = exports.SpatialProfile = exports.HistogramResponse = exports.HistogramDistRequest = exports.HistogramRequest = exports.SpectralProfileResponse = exports.SpectralProfileRequest = exports.Mask = exports.ImageDataResponse = exports.ImageDataRequest = exports.StatusResponse = exports.Empty = exports.RegionType = exports.protobufPackage = void 0;
...
function createBaseSetSpatialReq() {
    return { uuid: "", x: 0, y: 0 };
}
exports.SetSpatialReq = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.uuid !== "") {
            writer.uint32(10).string(message.uuid);
        }
    ...
    create(base) {
        return exports.SetSpatialReq.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSetSpatialReq();
...
function createBaseSetHistogramReq() {
    return { uuid: "", x: 0, y: 0, z: 0, width: 0, height: 0, depth: 0 };
}
exports.SetHistogramReq = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.uuid !== "") {
            writer.uint32(10).string(message.uuid);
        }
    ...
    create(base) {
        return exports.SetHistogramReq.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.x = (_b = object.x) !== null && _b !== void 0 ? _b : 0;
        message.y = (_c = object.y) !== null && _c !== void 0 ? _c : 0;
        message.z = (_d = object.z) !== null && _d !== void 0 ? _d : 0;
        message.width = (_e = object.width) !== null && _e !== void 0 ? _e : 0;
        message.height = (_f = object.height) !== null && _f !== void 0 ? _f : 0;
        message.depth = (_g = object.depth) !== null && _g !== void 0 ? _g : 0;
        return message;
    },
};
function createBaseSpatialProfileData() {
    return { uuid: "", profiles: [] };
}
exports.SpatialProfileData = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.uuid !== "") {
            writer.uint32(10).string(message.uuid);
        }
        for (const v of message.profiles) {
            exports.SpatialProfile.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.profiles.push(exports.SpatialProfile.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            uuid: isSet(object.uuid) ? globalThis.String(object.uuid) : "",
            profiles: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.profiles)
                ? object.profiles.map((e) => exports.SpatialProfile.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.profiles) === null || _a === void 0 ? void 0 : _a.length) {
            obj.profiles = message.profiles.map((e) => exports.SpatialProfile.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.SpatialProfileData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseSpatialProfileData();
        message.uuid = (_a = object.uuid) !== null && _a !== void 0 ? _a : "";
        message.profiles = ((_b = object.profiles) === null || _b === void 0 ? void 0 : _b.map((e) => exports.SpatialProfile.fromPartial(e))) || [];
        return message;
    },
};
...
exports.H5ServicesService = {
    ...
    getSpatialProfile: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(exports.SetSpatialReq.encode(value).finish()),
        requestDeserialize: (value) => exports.SetSpatialReq.decode(value),
        responseSerialize: (value) => Buffer.from(exports.SpatialProfileData.encode(value).finish()),
        responseDeserialize: (value) => exports.SpatialProfileData.decode(value),
    },
    getSpectralProfile: {
    ...
    getHistogram: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(exports.SetHistogramReq.encode(value).finish()),
        requestDeserialize: (value) => exports.SetHistogramReq.decode(value),
        responseSerialize: (value) => Buffer.from(exports.HistogramResponse.encode(value).finish()),
        responseDeserialize: (value) => exports.HistogramResponse.decode(value),
    },
};
exports.H5ServicesClient = (0, grpc_js_1.makeGenericClientConstructor)(exports.H5ServicesService, "proto.H5Services");
