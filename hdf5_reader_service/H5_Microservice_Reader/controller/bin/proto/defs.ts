...
export const RegionInfo = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.controlPoints.push(Point.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): RegionInfo {
    return {
      ...
      controlPoints: globalThis.Array.isArray(object?.controlPoints)
        ? object.controlPoints.map((e: any) => Point.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: RegionInfo): unknown {
    ...
    if (message.controlPoints?.length) {
      obj.controlPoints = message.controlPoints.map((e) => Point.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RegionInfo>, I>>(object: I): RegionInfo {
    ...
    message.controlPoints = object.controlPoints?.map((e) => Point.fromPartial(e)) || [];
    return message;
  },
};
